import {getOptimizedUrunResim} from "../../utils/getOptimizedUrunResim";

export default function ShopProductKart({onClick, product}) {
    ...
    return (
        <section className="shop-product-card flex flex-col w-[21.75rem] h-[38.438rem] md:w-[15rem] md:h-[30.5rem] hover:cursor-pointer" onClick={onClick}>
            <div className="shop-product-image flex justify-center w-60 h-[300px]">
                <img src={getOptimizedUrunResim(product?.images[0].url, 400)} className="object-center object-cover"/>
            </div>
