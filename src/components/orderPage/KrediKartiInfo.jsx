...
import {addCartCard} from "../../store/thunks/shoppingKartThunk";
import {deleteCard, getCards} from "../../store/thunks/clientThunk";
import KrediKartiForm from "./KrediKartiForm";

export default function KrediKartiInfo({ setStep }) {
    useEffect(() => {
    window.scrollTo(0, 0);
  }, []);
  ...
  return (
    <section className="credit-card-info-main">
      ...
      <div className="card-form">
        {formSection && <KrediKartiForm card={cardData} />}
      </div>
    </section>
  );
}