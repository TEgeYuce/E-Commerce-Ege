...
import {editAddress, addAddress} from "../../store/thunks/clientThunk";

export default function AdresForm({ address }) {
  const {
    register,
    handleSubmit,
    reset,
  ...
  return (
    <section className="address-form-main flex flex-col items-center gap-5 mt-10">
      <div className="form-title flex items-start">
        <h2 className="text-[#252B42] text-2xl font-bold leading-[3.125rem] text-center">
          Create New Address
        </h2>
      </div>
      <div className="address-form">
        ...
        >
          <div className="address-title flex flex-col">
            <label htmlFor="title" className="text-lg leading-6">
              Title
            </label>
            <input
              {...register("title", {
          ...
          <div className="address-fullname flex md:flex-col gap-4">
            <div className="address-name flex flex-col">
              <label htmlFor="name" className="text-lg leading-6">
                Name
              </label>
              <input
                {...register("name", {
            ...
            <div className="address-surname flex flex-col">
              <label htmlFor="surname" className="text-lg leading-6">
                Surname
              </label>
              <input
                {...register("surname", {
          ...
          <div className="address-phone flex flex-col">
            <label htmlFor="phone" className="text-lg leading-6">
              Phone
            </label>
            <input
              {...register("phone", {
          ...
          <div className="address-city flex flex-col">
            <label htmlFor="city" className="text-lg leading-6">
              City
            </label>
            <select
          ...
          <div className="address-district flex flex-col">
            <label htmlFor="district" className="text-lg leading-6">
              District
            </label>
            <input
              {...register("district", {
                ...
                maxLength: {
                  value: 30,
                  message: "District cannot be longer than 30 characters.",
                },
              })}
              id="district"
              name="district"
          ...
          <div className="address-neighborhood flex flex-col">
            <label htmlFor="neighborhood" className="text-lg leading-6">
              Neighborhood
            </label>
            <input
              {...register("neighborhood", {
                ...
                maxLength: {
                  value: 30,
                  message: "Neighborhood cannot be longer than 30 characters.",
                },
              })}
              id="neighborhood"
              name="neighborhood"
          ...
          <div className="address-address flex flex-col">
            <label htmlFor="address" className="text-lg leading-6">
              Address
            </label>
            <textarea
              {...register("address", {
                ...
                maxLength: {
                  value: 50,
                  message: "Address cannot be longer than 30 characters.",
                },
              })}
              id="address"
              name="address"
