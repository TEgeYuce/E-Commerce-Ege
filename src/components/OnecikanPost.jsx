    ...
    return (
        <>
            <section className="featured-post mobile flex flex-col items-center md:hidden">
                <div className="post-image w-[20.625rem] h-[18.75rem] relative bg-cover bg-center" style={{backgroundImage: `url(${OnecikanPostResim})`}}>
            ...
            <section className="featured-post desktop hidden md:flex">
                <div className="post-image md:w-[13.063rem] md:h-[25.25rem] relative bg-cover bg-center" style={{backgroundImage: `url(${OnecikanPost1})`}}>
