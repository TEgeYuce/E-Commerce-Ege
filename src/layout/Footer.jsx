    ...
    return (
        <footer className="footer mt-10">
            <section className={`socials ${bgColor} flex flex-col py-10 px-10 gap-8 md:flex-row md:justify-between md:px-35`}>
                <div className="logo">
                    <h3 className="text-2xl font-bold leading-8 text-[#252B42]">TEgeYuce</h3>
                </div>
            ...
            <section className="copyright bg-[#FAFAFA] py-[1.563rem]">
                <div className="flex justify-center md:justify-start md:px-60">
                    <span className="text-[#737373] text-sm font-bold leading-6 text-center md:hidden">Made With Love By TEgeYuce<br/> All Right Reserved </span>
                    <span className="text-[#737373] text-sm font-bold leading-6 text-center hidden md:block">Made With Love By TEgeYuce All Right Reserved </span>
                </div>
            </section>
        </footer>
    );
