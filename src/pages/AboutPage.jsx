...
import sirketHakkinda from "/sirkethakkinda.png";
import MarkaLogolar from "../components/sharedcomp/MarkaLogolar";
import referanslarHakkinda from "/referanslarhakkinda.jpg";
import videoHakkinda from "/videohakkinda.jpg"
     ...
     <section className="about-company-main mt-5">
        <div className="about-company-content flex flex-col items-center gap-5 md:flex-row md:gap-20 md:justify-center">
          <div className="about-company-text flex flex-col gap-10 items-center py-20 md:items-start">
            ...
            <button className="bg-[#23A6F0] text-white text-sm leading-[1.375rem] font-bold py-[0.938rem] px-10 rounded-[0.313rem] w-48 h-[4.25rem] hover:cursor-pointer">Get Quote Now</button>
          </div>
          <div className="about-company-img w-[24.188rem] h-[27.5rem] md:w-[39.5rem] md:h-[38.25rem]">
            <img src={sirketHakkinda} alt="" />
          </div>
        </div>
      </section>
      ...
      <section>
        <div className="about-video-content flex justify-center relative">
            ...
            <img src={videoHakkinda} className="w-[19.188rem] h-[19.75rem] rounded-xl md:rounded-[1.25rem] object-cover object-center md:w-[61.813rem] md:h-[33.75rem]" />
        </div>
      </section>
        ...
        <section className="about-testimonails-main">
            <div className="about-testimonails-content md:flex">
                ...
                <div className="testimonails-img hidden md:block object-contain object-center">
                    <img src={referanslarHakkinda} className="w-[36.875rem] h-[35rem]"/>
                </div>
            </div>
        </section>
    </>
