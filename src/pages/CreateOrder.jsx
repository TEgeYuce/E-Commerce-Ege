import KrediKartiInfo from "../components/orderPage/KrediKartiInfo";
import ConfirmSiparis from "../components/orderPage/ConfirmSiparis";
import AdresInfo from "../components/orderPage/AdresInfo";
            ...
            <div className="container mx-auto px-4 py-8">
                <div className="create-order-content">
                    ...
                    <div className="create-order-container bg-white rounded-lg shadow-sm">
                        {step === 1 && <AdresInfo setStep={setStep} />}
                        {step === 2 && <KrediKartiInfo setStep={setStep}/>}
                        {step === 3 && <ConfirmSiparis setStep={setStep}/>}
                    </div>
                </div>
            </div>
        </section>
